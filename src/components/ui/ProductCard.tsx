...
export const ProductCard: FC<ProductCardProps> = ({ name, imageUrl }) => {
  return (
    <div className="flex w-full flex-col justify-center items-center max-w-[300px] overflow-hidden rounded-lg bg-black shadow-md">
